...
def getYoloDetector(threshold = 0.6):
	darkflowPath = "../darkflow/"
	options = {"model": darkflowPath+"cfg/tiny-yolo-voc-car.cfg", 
	    	  	 "load": 618,# darkflowPath+"tiny-yolo-voc-car.weights", 
			   		 "threshold": threshold,
			   		 "gpu": 0.5,
                     "labels": darkflowPath + "labels.txt",
			   		 "config": darkflowPath+"cfg/",
                     "backup": darkflowPath+"ckpt/",
			   		 "summary": None}
	tfnet = TFNet(options)
